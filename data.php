...
$ch = $json["-1002399499274"]; //ايدي قناة الصيد
$done = $json["-1002478530754"]; //ايدي قناة الاثباتات
$admin = 5207032121; //الادمن حق البوت
$api_key =$json["b3Q4LytFRzNhMS8xcG1HamtXSEdHQT09"]; //api key حق حسابك
$user = $json["Mohamed770"]; //اسم المستخدم حق حسابك
$pass = $json["mohamed123="]; // كلمة السر حق حسابك
$app = $json["0257"]; // التطبيق
require "class.php";
